...
const Work = () => {
  return (
    <div className="py-10 text-left font-lilex text-black dark:text-white" id="work">
      <h2 className="text-3xl font-bold mb-8 font-instrument">Work Experience</h2>
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <ul className="list-disc ml-5 mt-2 text-gray-700 dark:text-gray-300 space-y-1">
            ...
            <li>Contributed to significant architectural improvements and feature rollouts (see GitHub PRs).</li>
          </ul>
        </div>
