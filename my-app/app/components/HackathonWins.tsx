       ...
       <div className='border-1 border-gray-300 rounded-xl '>
        ...
        <div>
            <h1 className='font-lilex lg:text-2xl lg:ml-3 font-bold'>Hackathon Winner</h1>
             <h1 className='font-lilex lg:text-l lg:ml-3 font-bold'><a href='https://luma.com/rvz8bst9?tk=PbGwgj' target='black' rel='noopener noerferrer' className='text-blue-700'>DevDay Hackathon</a> by @apify and @hackthisfall</h1>
        </div>
        </div>
...
// https://apify.com/stylish_panduri/gitwrap


// https://unstop.com/hackathons/hacktofuture-30-st-joseph-engineering-college-mangaluru-1380851